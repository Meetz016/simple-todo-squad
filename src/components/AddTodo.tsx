  ...
  return <form onSubmit={handleSubmit} className="flex gap-3 mb-6">
      <div className="flex-1 relative">
        <Input 
          ...
          data-has-text={text.length > 0}
          className="pr-12 bg-gradient-card border-border focus:border-primary focus:ring-1 focus:ring-primary text-foreground placeholder:text-muted-foreground data-[has-text=true]:bg-blue-600 data-[has-text=false]:bg-purple-600" 
        />
      </div>
