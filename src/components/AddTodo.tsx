...
export const AddTodo = ({
  ...
  return <form onSubmit={handleSubmit} className="flex gap-3 mb-6">
      ...
      <Button type="submit" disabled={!text.trim()} className="bg-gradient-primary hover:shadow-elegant transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 mx-[29px] px-[3px]">
